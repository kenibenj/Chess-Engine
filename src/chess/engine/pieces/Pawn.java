...
public class Pawn extends Piece{
    ...
    private static final int[] POTENTIAL_MOVE_COORDINATES = {7, 8, 9, 16};
    ...
    public Collection<Move> findLegalMoves(final Board board) {
        ...
        for(final int currentPotentialMoveOffset : POTENTIAL_MOVE_COORDINATES){
            ...
            //Pawn Jump
            else if(potentialMoveCoordinate == 16 && this.isFirstMove() &&
                    ((BoardUtils.SEVENTH_RANK[this.piecePosition] && this.getPieceTeam().isBlack()) ||
                    (BoardUtils.SECOND_RANK[this.piecePosition] && this.getPieceTeam().isWhite()))){
